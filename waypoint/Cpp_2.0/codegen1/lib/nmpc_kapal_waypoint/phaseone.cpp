              ...
              const k_struct_T &runTimeOptions)
{
  ...
  solution.fstar = solution.xstar[nVar];
  solution.state = 5;
        ...
        if (solution.state != -5) {
          ...
          if (updateFval) {
            ...
            case 3:
              ...
              idxStartIneq = 101 * (idx_local - 1);
              idxEndIneq = 101 * (workingset.nActiveConstr - 1);
              i = workingset.nVar;
      ...
      if (guard1) {
        ...
        if (solution.iterations - div_nzp_s32(solution.iterations) * 50 == 0) {
          ...
          if (minLambda > 1.0E-6) {
            ...
            if (idxStartIneq - 1 >= 0) {
              std::copy(&solution.xstar[0], &solution.xstar[idxStartIneq],
            ...
            if (minLambda < solution.maxConstr) {
              if (idxStartIneq - 1 >= 0) {
                std::copy(&solution.searchDir[0],
                          &solution.searchDir[idxStartIneq],
                          &solution.xstar[0]);
              }
