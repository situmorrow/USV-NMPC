%% ============================================================================
%                          VALIDASI MODEL MATEMATIKA KAPAL (SPESIFIKASI SKALA FROUDE)
...
% * Model yang digunakan adalah model kapal 2 DOF (sway dan yaw).
% * Metode numerik Runge-Kutta orde 4 (RK4) digunakan untuk mengintegrasikan.
% * Skala Froude digunakan untuk mengubah parameter kapal dari skala penuh ke skala model.
% =============================================================================
clear; clc; close all;
set(0, 'DefaultFigureWindowStyle', 'docked'); % Dock kustomisasi 1 window (tabbed)

fprintf('  SIMULASI VALIDASI MODEL MATEMATIKA KAPAL (SPESIFIKASI SKALA FROUDE) \n');
fprintf('================================================================\n\n');

%% READ & PREPROCESS DATA EKSPERIMEN CSV
csvPath = 'turning_cleaning.csv';
...
delta_deg_exp = movmean(delta_deg_exp, 5);
delta_deg_exp = max(min(delta_deg_exp, 35), -35);
...
%% FUNGSI KONVERSI DIMENSIONAL DAN NONDIMENSIONAL
