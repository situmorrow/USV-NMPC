function [u_opt, exitflag] = nmpc_kapal(current_state_nd, u_prev, x_ref_seq, y_ref_seq, psi_ref_seq)
%#codegen
...
%   x_ref_seq        : [N x 1] posisi X referensi horizon
%   y_ref_seq        : [N x 1] posisi Y referensi horizon
