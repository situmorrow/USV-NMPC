...
//
// _coder_nmpc_kapal_waypoint_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "nmpc_kapal_waypoint",                                // fFunctionName
...
void nmpc_kapal_waypoint_api(const mxArray *const prhs[6], int32_T nlhs,
                             const mxArray *plhs[2])
{
  ...
  u_0 = b_emlrt_marshallIn(st, emlrtAliasP(prhs[2]), "u_0");
  x_ref_seq = c_emlrt_marshallIn(st, emlrtAlias(prhs[3]), "x_ref_seq");
  y_ref_seq = c_emlrt_marshallIn(st, emlrtAlias(prhs[4]), "y_ref_seq");
  psi_ref_seq = c_emlrt_marshallIn(st, emlrtAlias(prhs[5]), "psi_ref_seq");
  // Invoke the target function
  nmpc_kapal_waypoint(*current_state_nd, u_prev, u_0, *x_ref_seq, *y_ref_seq,
                      *psi_ref_seq, &u_opt, &exitflag);
...
void nmpc_kapal_waypoint_atexit()
{
  ...
  nmpc_kapal_waypoint_xil_terminate();
  nmpc_kapal_waypoint_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
// End of code generation (_coder_nmpc_kapal_waypoint_api.cpp)
